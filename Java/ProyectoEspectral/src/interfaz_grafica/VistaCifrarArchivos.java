...
public class VistaCifrarArchivos extends JPanel {
    
    //Atributos de la clase Vista Cifrar Archivos correspondientes a cada uno de los elementos graficos
    private JTextField rutaArchivoSeleccionado;
    private JButton botonBuscar, botonCifrar, botonEliminar;
    private JLabel zonaArrastre, tituloVista;
    private JTable tablaArchivos;
    private DefaultTableModel modeloTablaArchivos;
    private JScrollPane scrollPane;

    //Constructor de la clase VistaCifrarArchivos
    public VistaCifrarArchivos() {
        configurarPanel();             
    ...
    //Méotodo para configurar el estilo de la tabla
